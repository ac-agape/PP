...
if __name__ == "__main__":
    ...
    open_paranthesis = Button(gui, text=' ( ', fg='white', bg='blue',
                     command=lambda: press("("), height=1, width=7)
    open_paranthesis.grid(row=2, column=4)

    closed_paranthesis = Button(gui, text=' ) ', fg='white', bg='blue',
                              command=lambda: press(")"), height=1, width=7)
    closed_paranthesis.grid(row=3, column=4)
